        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <Card className="border-2 border-primary/20 hover:border-primary/40 transition-colors">
            <CardContent className="p-8 text-center space-y-4">
              ...
              <h3 className="text-2xl font-bold">Besoin d'aide ?</h3>
              <p className="text-muted-foreground">
                Vous ou un proche êtes en difficulté ? Nous sommes là pour vous écouter et vous accompagner.
              </p>
          ...
          <Card className="border-2 border-secondary/20 hover:border-secondary/40 transition-colors">
            <CardContent className="p-8 text-center space-y-4">
              ...
              <h3 className="text-2xl font-bold">Rejoindre</h3>
              <p className="text-muted-foreground">
                Participez à nos ateliers et trouvez du soutien au sein d'un groupe bienveillant.
              </p>
          ...
          <Card className="border-2 border-accent/20 hover:border-accent/40 transition-colors">
            <CardContent className="p-8 text-center space-y-4">
              ...
              <h3 className="text-2xl font-bold">Soutenir</h3>
              <p className="text-muted-foreground">
                Aidez-nous à poursuivre notre mission par un don, une adhésion ou comme bénévole.
              </p>
